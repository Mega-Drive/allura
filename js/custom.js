...
$(document).ready(function()
{
	...
	*/
	...
	$(document).on('scroll', function()
	{
		...
		else
		{
			if($(window).scrollTop() > 100)
			{
				header.css({"background":"rgba(37, 40, 57, 0.8)"});
			}
			else
			{
	...
	*/
	...
	{
		$('.parallax-window').parallax({imageSrc: 'images/home_background.jpg'});
		$('.stats_background').parallax({imageSrc: 'images/stats_background.jpg'});
	}
